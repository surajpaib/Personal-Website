                ...
                if (key == 13) {
                    ...
                    if ($('#inputfield'+counter.toString()).val() == "ls") {
                        ...
                        if ( filename.toString() == 'experience.txt' ){
                            var exp0 = '<br><table class = "cmdline"><tbody><tr><td><span id="headline"> Associate Engineer, Digital Image Processing </span></td><td><span id="headline"> Cognitive Machines</span></td></tr><tr><td>July 2017 - Present</td></tr></tbody></table> <p><ul><li>As a DIP Engineer, worked on object detection algorithms using OpenCV and Tensorflow Models.</li> <li>Part of the visualization procedure exposed me to Metabase and MySQL DB for result management.</li> <li>Deployed tensorflow models on production using EC2 instances.</li></ul> </p>';
                            ...
                            var desc = exp0 + exp1 + exp2 + exp3 + exp4;
                            $("#console").append(desc);
                        }
                            ...
                            var proj6 = '<br><table class = "cmdline"><tbody><tr><td><span id="headline">Speaker Diaterization System</span></td></tr></tbody></table><br>Built a remote server that identifies and discriminates users based on their voice fingerprints. Employed MFCC feature vectors along with RF decision trees to achieve a 40 percent difference in confidence scores between false and true classifications. The system was architectured using Django and can accomodate dynamic user entry and subsequent classification.<br>';

                            var proj = proj1 + proj2 + proj3 + proj4 + proj5 + proj6 ;
                            $('#console').append(proj);
