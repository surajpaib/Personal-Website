                ...
                if( key == 9){
                    ...
                    $('#inputfield'+counter.toString()).val('ls');
                            ...
                            if ( val2.toString() == "ed"){
                                ...
                                input.focus().val("").blur().focus().val('cat projects.txt').focus();
